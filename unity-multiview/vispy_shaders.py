...
"""
# consider building individual fragment shaders through concatentation of strings
# this will allow us to reuse the same fragment shader code whilst having the option of
# using the different point representations
FRAGMENT_SHADER = """
#version 120
// Constants
// ------------------------------------
